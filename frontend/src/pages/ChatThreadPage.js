...
const ChatThreadPage = ({ user }) => {
  ...
  return (
    <div className="min-h-screen bg-background-DEFAULT flex flex-col" data-testid="chat-thread-page">
      ...
      {/* Messages */}
      <div ref={scrollerRef} className="flex-1 overflow-y-auto max-w-2xl w-full mx-auto p-3 pb-28">
        {messages.length === 0 && (
      ...
      {/* Composer */}
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-3 py-2 z-40" data-testid="dm-composer">
