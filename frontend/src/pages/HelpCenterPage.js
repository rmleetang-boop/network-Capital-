...
const FAQS = [
  ...
  { cat: 'score', q: 'Is there a cap?', a: 'Yes — 10,000 per month. Your monthly_score resets at the start of every calendar month and earns the highest badge of the period (Bronze Networker 1k → Network Legend 10k).' },
