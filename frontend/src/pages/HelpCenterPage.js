...
const FAQS = [
  ...
  // Network Score
  { cat: 'score', q: 'What increases my Network Score?', a: 'Three tiers: T1 Ads — Watch & engage with ads +500 (5/day) · Share an ad 300/150/50/50/50 (diminishing). T2 Referrals — Referred member crosses 1,000 same month +400 · Feature unlock by friend +200 · Friend posts in first 7 days +150. T3 Standard — Post +50 (5/day) · Comment ≥0.6 AI quality +30 (10/day) · Like +5 (20/day) · Share +20 (10/day) · Video watched +10 (10/day) · Daily check-in +10 · Story +5 · Weekly Resource Drop +30 · Profile completion +250 · First Stokvel join +250 · Host an Activity +150 · Join an Activity +25. NEW iter 25 — Post a Place review (+40) · Make a new connection (+25 each side) · Share a Job (+20). Premium / Founder window doubles all gains (max 2×).' },
  { cat: 'score', q: 'Is there a cap?', a: 'No hard cap — your score grows for every meaningful action you take. Reaching 10,000 points in a single calendar month earns the Top Contributor badge for that month. Daily and weekly soft caps on repeated identical actions still apply to keep things fair.' },
  { cat: 'score', q: 'What does a high score unlock?', a: '500+ Stokvel eligibility · 2,000+ priority on Activities · 3,000+ verified badge · 4,000+ creator marketplace listing · 5,000+ Hub leaderboard placement · 10,000+ in a month = Top Contributor badge + claim 3 months free Premium + permanent Steward badge.' },
